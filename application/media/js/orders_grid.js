function gen_table() { 
	...
	datatype: "json",
   	...
   	colModel: [
	        {name:'o.id',index:'o.id', align:"left",searchoptions:{sopt:['eq','ne','lt','le','gt','ge']}, editable:false},
		{name:'login',index:'login', align:"left",searchoptions:{sopt:['bw','bn','ew','en','cn','nc']}, editable:false},
   		{name:'products_cnt',index:'products_cnt', align:"left",searchoptions:{sopt:['eq','ne','lt','le','gt','ge']}, editable:false},
   		{name:'total_price',index:'total_price',align:"left",searchoptions:{sopt:['eq','ne','lt','le','gt','ge']}, editable:false},
		...
		{name:'address',index:'address', align:"left",searchoptions:{sopt:['bw','bn','ew','en','cn','nc']}, editable:false},
   	],
   	rowNum:10,
   	rowList:[10, 20, 30],
   	pager: '#pager',
